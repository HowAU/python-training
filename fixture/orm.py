...
class ORMFixture:
    ...
    class ORMContact(db.Entity):
        ...
        id = PrimaryKey(int, column='id')#название столбца, где расположено значение можно не указывать если его наименование совпадает с наименованием значения, но все же лучше указывать
